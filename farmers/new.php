...
<body>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="card" style="width: 23rem;margin-left:18px;">
                <img src="images/scheme-1" class="card-img-top" alt="..." style="height:250px">
                <div class="card-body">
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 23rem;">
                <img src="images/scheme-2" class="card-img-top" alt="..." style="height:250px">
                <div class="card-body">
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 23rem;">
                <img src="images/scheme-3" class="card-img-top" alt="..." style="height:250px">
                <div class="card-body">
